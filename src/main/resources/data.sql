...
insert into melhor_data_compra(id,data_melhor_compra,data_pagamento,forma_pagamento_id,usuario_id,mes_referencia) values (1,29,10,2,1,CURDATE());
insert into melhor_data_compra(id,data_melhor_compra,data_pagamento,forma_pagamento_id,usuario_id,mes_referencia) values (2,11,11,3,1,CURDATE());
